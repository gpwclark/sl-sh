...
any of: ("[fs-exists?](#root::fs-exists?)" "[fs-file?](#root::fs-file?)" "[char?](#root::char?)" "[string?](#root::string?)" "[int?](#root::int?)" "[float?](#root::float?)" "[hash?](#root::hash?)" "[symbol?](#root::symbol?)" "[nil?](#root::nil?)" "[list?](#root::list?)" "[vec?](#root::vec?)" "[fs-dir?](#root::fs-dir?)" "[macro?](#root::macro?)" "[lambda?](#root::lambda?)")
Rules for flags:
...
version: sl-sh 0.9.49 (master:0a09194, release build, linux [x86_64], May 21 2021, 02:38:38 UTC [rustc 1.52.1 (9bc8c42bb 2021-05-09)])
